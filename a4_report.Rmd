...
ggplot(lobster_distributions, aes(x = size_mm, y = site2, fill = year))+
  ...
  labs(x = "Carapace length (mm)",
       y = "Site",
       fill = NULL,
       title = "CA Spiny Lobster size distributions in the Santa Barbara Channel",
